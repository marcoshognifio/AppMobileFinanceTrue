    ...
    if(amount< currentProject['recette_actuelle']){
      ...
      showDialog(
          ...
          builder: (context) =>AlertDialog(
            title: const Text("Confirmation de la dépense",style: TextStyle(fontFamily: 'Roboto-Regular',),),
            content:  Column(
              children: [
            ...
            actions: [
              TextButton(onPressed: (){ saveSpend(getImage);}, child: const Text("Valider",style: TextStyle(fontFamily: 'Roboto-Regular',),)),
      ...
      showDialog(
          ...
          builder: (context) =>AlertDialog(
            ...
            content: const Text('Le fond de votre projet est insuffisant pour enregistrer cette dépense',
                        textAlign: TextAlign.center,style: TextStyle(fontFamily: 'Roboto-Regular',),),
            actions: [
              TextButton(onPressed:(){Navigator.pop(context);}, child: const Text("Quitter",style: TextStyle(fontFamily: 'Roboto-Regular',),))
            ],
          )
      );
    }
              ...
              title:  Row(
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text(item['quantite'],style: const TextStyle(fontFamily: 'Roboto-Regular',fontWeight: FontWeight.w900,fontSize: 15,color: Color(
                          0xff838080))),
                    )
                  ]
              ),
